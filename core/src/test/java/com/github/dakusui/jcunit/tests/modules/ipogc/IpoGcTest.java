...
public class IpoGcTest {
  ...
  public void givenSize3FactorSpaceWithNoConstraint$whenGenerateTestSuite$thenWorksFine() {
    ...
    int strength;
    Constraint[] constraints = new Constraint[] {};
    List<Tuple> generated = new IpoGc(strength = 2, constraintChecker(constraints), factors = createFactors(3)).ipo().getGeneratedTuples();
  ...
  public void givenSize2FactorSpaceWithConstraintForA$whenGenerateTestSuite$thenWorksFine() {
    ...
    List<Tuple> generated = new IpoGc(strength = 2, constraintChecker(constraints), factors = createFactors(2)).ipo().getGeneratedTuples();
  ...
  public void givenSize4FactorSpaceWithConstraintForAandB$whenGenerateTestSuite$thenWorksFine() {
    ...
    List<Tuple> generated = new IpoGc(strength = 2, constraintChecker(constraints), factors = createFactors(4)).ipo().getGeneratedTuples();

    assertNoViolations(constraints, generated);
    assertNoMissingTuples(factors, strength, constraints, generated);

    assertEquals("[{C=C1, D=D1, A=A1, B=B1}, {C=C1, D=D2, A=A1, B=B1}, {C=C2, D=D1, A=A1, B=B1}, {C=C2, D=D2, A=A1, B=B1}]", generated.toString());
    assertEquals(4, generated.size());
  }
  ...
  public void givenSize4FactorSpaceWithConstraintForORedAandB$whenGenerateTestSuite$thenWorksFine() {
    ...
    assertEquals(
        "["
            + "{C=C1, D=D1, A=A1, B=B1}, {C=C1, D=D2, A=A1, B=B2}, {C=C2, D=D1, A=A2, B=B1}, "
            + "{C=C2, D=D2, A=A1, B=B1}, {C=C1, D=D1, A=A2, B=B1}, {C=C2, D=D2, A=A2, B=B1}, "
            + "{C=C2, D=D1, A=A1, B=B2}]"
        , generated.toString());
  ...
  public void givenSize6FactorSpaceWithConstraintForCandORedAandB$whenGenerateTestSuite$thenWorksFine() {
    ...
    List<Tuple> generated = new IpoGc(
        strength = 2,
        constraintChecker(constraints),
        factors = createFactors(6)).ipo().getGeneratedTuples();
    ...
    assertEquals(
        "["
            ...
            + "{D=D1, E=E1, F=F2, A=A2, B=B1, C=C1}, {D=D1, E=E2, F=F2, A=A2, B=B1, C=C1}, "
            + "{D=D1, E=E2, F=F1, A=A2, B=B1, C=C1}, {D=D1, E=E1, F=F2, A=A1, B=B2, C=C1}]"
        , generated.toString());
  ...
  public void givenSize4FactorSpaceWithConstraintForAandC$whenGenerateTestSuite$thenWorksFine() {
    ...
    List<Tuple> generated = new IpoGc(strength = 2, constraintChecker(constraints), factors = createFactors(4, 4, 1, 3, 24)).ipo().getGeneratedTuples();
  ...
  public void givenSize5FactorSpaceWithConstraintForAandC$whenGenerateTestSuite$thenWorksFine() {
    ...
    Factors factors;
    List<Tuple> generated = new IpoGc(strength, constraintChecker(constraints), factors = createFactors(5, 4, 1, 3, 3, 24)).ipo().getGeneratedTuples();
  ...
  private Constraint and(final Constraint... constraints) {
    return new Constraint() {
      ...
      @Override
      public String toString() {
        return format("'and(%s)", StringUtils.join(",", new Object[] { constraints }));
      }
    };
  }
