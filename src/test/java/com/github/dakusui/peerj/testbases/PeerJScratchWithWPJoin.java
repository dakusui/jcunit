...
public class PeerJScratchWithWPJoin extends PeerJScratch {
  public PeerJScratchWithWPJoin(Spec spec) {
    super(spec);
  }
  ...
  public void scratchGenerationWithWeakenProductCombinatorialJoin() {
    ...
    StopWatch<PeerJScratch, List<Tuple>> stopWatch = new StopWatch<>(
        Printable.function("conductScratchJoinExperiment", (PeerJScratch self) -> generateWithCombinatorialJoin(requirement, baseDir, partitioner, factorSpace, algorithm(), constraintHandlingMethod(), "")),
