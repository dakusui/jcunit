...
import com.github.dakusui.peerj.testbases.PeerJScratchWithWPJoinBasedOnPict;
...
public class SyntheticModelSuiteForScratchGenerationWithWPJoinBasedOnPict {
  public static class Sandbox extends PeerJScratchWithWPJoinBasedOnPict {
    ...
    public static List<Spec> parameters() {
      return PeerJBase.parametersWith(2, SOLVER, 20, 60)
          .stream()
  ...
  public static class Strength2 extends PeerJScratchWithWPJoinBasedOnPict {
  ...
  public static class Strength3 extends PeerJScratchWithWPJoinBasedOnPict {
  ...
  public static class Strength4 extends PeerJScratchWithWPJoinBasedOnPict {
  ...
  public static class Strength5 extends PeerJScratchWithWPJoinBasedOnPict {
  ...
  public static class VSCA_2_3 extends PeerJScratchWithWPJoinBasedOnPict {
  ...
  public static class VSCA_2_4 extends PeerJScratchWithWPJoinBasedOnPict {
  ...
  public static class Strength4Degree80 extends PeerJScratchWithWPJoinBasedOnPict {
    private static final int T = 4;
  ...
  public static class Debug extends PeerJScratchWithWPJoinBasedOnPict {
