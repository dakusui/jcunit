package com.github.dakusui.jcunit.extras.ct;
...
public class JCUnitTest extends JCUnitBase {
  ...
  public static class BadGenerator_ConstructorWithParameters<T> extends
      BaseTestArrayGenerator<T> {
    public BadGenerator_ConstructorWithParameters(Object dummy1,
        Object dummy2) {
    }
  ...
  public static class BadGenerator_PrivateConstructor<T> extends
      BaseTestArrayGenerator<T> {
