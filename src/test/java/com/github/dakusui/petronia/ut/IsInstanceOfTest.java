...
public class IsInstanceOfTest extends DefaultRuleSetBuilder implements Serializable {
	...
	public void isinstanceof_03() throws JCUnitException, CUT {
		assertTrue((Boolean)Basic.eval(this, isinstanceof(this, Serializable.class)));
	}
	@Test
	public void isinstanceof_04() throws JCUnitException, CUT {
		assertTrue(!(Boolean)Basic.eval(this, isinstanceof(this, Comparable.class)));
	}
	@Test
