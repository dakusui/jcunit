...
public class OutFieldNamesTest extends DefaultRuleSetBuilder {
	...
	public void test00a() throws SymbolNotFoundException, JCUnitException, CUT {
		...
		assertEquals(0, ((Object[])Basic.eval(this, this.outFieldNames(obj))).length);
	}
	@Test
	...
	public void test02a() throws SymbolNotFoundException, JCUnitException, CUT {
		...
		assertTrue(Arrays.equals(new Object[]{"test1", "test2"}, (Object[])Basic.eval(this, this.outFieldNames(obj))));
	}
	@Test
