...
public class Test {
	...
	public static void m(int i) { System.out.println("m(int)"); }
	public static void m(int i,int j) { System.out.println("m(int,int)"); }
	public static void m(int i,int j,String[] k) { System.out.println("m(int,int,String[])"); }
	public static void m(int i,int j,short p1, long p2, char p3, boolean p4, float p5, boolean p7,String[] k,String l,Object m) { System.out.println("m(int,int,String[])"); }
	public static void m(Integer i) { System.out.println("m(Integer)"); }
	
	public static void n(int i) { System.out.println("n(int)"); }
	
	public static void o(Integer i) { System.out.println("o(Integer)");}
	...
	public static void _main(String[] args) throws SecurityException, NoSuchMethodException {
		...
		System.out.printf("m(int,int,String[]):%s\n", ArrayUtils.toString(getMethod("m", Integer.TYPE, Integer.TYPE,new String[]{}.getClass())));
		...
		//System.out.printf("p(null):%s\n", ArrayUtils.toString(getMethod("p", null)));
	...
	protected static String getMethod(String methodName, Class<?>... paramType) {
		try {
			Method m = Test.class.getDeclaredMethod(methodName, (Class<?>[]) paramType);
