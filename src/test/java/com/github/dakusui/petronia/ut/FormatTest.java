...
public class FormatTest extends DefaultRuleSetBuilder {
	...
	public void format_02() throws Exception {
		//System.out.println("==>" + Basic.eval(this, format("-%s-", bigInteger(1))));
	...
	public void format_04() throws Exception {
		// 2 arguments test
		assertEquals("*hello*world*everyone*", Basic.eval(this,  format("*%s*%s*%s*", "hello", "world", "everyone")));
	}
	
	public static void main(String[] args) {
		Object cons = cons("format", new Object[]{"-%d-", cons("bigInteger", new Object[]{1})});
