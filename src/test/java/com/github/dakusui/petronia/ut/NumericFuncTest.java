...
public class NumericFuncTest extends DefaultRuleSetBuilder {
	...
	public void addint_02() throws Exception {
		assertEquals(new BigDecimal(2), Basic.eval(this, new Add().bind(intnum, intnum)));
	}
	
	@Test 
	public void addint_03() throws Exception {
		assertEquals(new BigDecimal(3), Basic.eval(this, new Add().bind(intnum, intnum, intnum)));
	}
	...
	public void addlong_02() throws Exception {
		assertEquals(new BigDecimal(2), Basic.eval(this, new Add().bind(longnum, longnum)));
	}
	
	@Test 
	public void addlong_03() throws Exception {
		assertEquals(new BigDecimal(3), Basic.eval(this, new Add().bind(longnum, longnum, longnum)));
	}
	...
	public void addbyte_02() throws Exception {
		assertEquals(new BigDecimal(2), Basic.eval(this, new Add().bind(bytenum, bytenum)));
	}
	
	@Test 
	public void addbyte_03() throws Exception {
		assertEquals(new BigDecimal(3), Basic.eval(this, new Add().bind(bytenum,bytenum, bytenum)));
	}
	...
	public void addfloat_02() throws Exception {
		assertEquals(new BigDecimal(2), Basic.eval(this, new Add().bind(floatnum, floatnum)));
	}
	
	@Test 
	public void addfloat_03() throws Exception {
		assertEquals(new BigDecimal(3), Basic.eval(this, new Add().bind(floatnum, floatnum, floatnum)));
	}
	...
	public void adddouble_02() throws Exception {
		assertEquals(new BigDecimal(2), Basic.eval(this, new Add().bind(doublenum, doublenum)));
	}
	
	@Test 
	public void adddouble_03() throws Exception {
		assertEquals(new BigDecimal(3), Basic.eval(this, new Add().bind(doublenum, doublenum, doublenum)));
	}

	@Test 
	public void subint_03() throws Exception {
		assertEquals(new BigDecimal(-1), Basic.eval(this, new Sub().bind(intnum, intnum, intnum)));
	}

	@Test 
	public void mulint_03() throws Exception {
		assertEquals(new BigDecimal(8), Basic.eval(this, new Mul().bind(2, 2.0d, 2.0f)));
	}

	@Test 
	public void divint_03() throws Exception {
		assertEquals(new BigDecimal(2), Basic.eval(this, new Div().bind(8, 2.0d, 2.0f)));
	}
