...
public class QuoteTest extends DefaultRuleSetBuilder {
	...
	public void quote_02() throws Exception {
		assertArrayEquals(new Object[]{1, 2}, (Object[])(Basic.eval(this, quote(1, 2))));
	}

	@Test
	public void quote_03() throws Exception {
		assertArrayEquals(new Object[]{1, 2, 3}, (Object[])(Basic.eval(this, quote(1, 2, 3))));
	}

	@Test
	public void q_03() throws Exception {
		assertArrayEquals(new Object[]{1, 2, 3}, (Object[])(Basic.eval(this, q(1, 2, 3))));
	}
}
