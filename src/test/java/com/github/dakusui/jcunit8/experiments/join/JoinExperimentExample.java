...
public class JoinExperimentExample {
  ...
  public void example1() {
    new JoinExperiment.Builder()
        .lhs(new CompatFactorSpaceSpec("L").addFactors(2, 20))
        .rhs(new CompatFactorSpaceSpec("R").addFactors(2, 20))
        .strength(4)
        .times(10)
  ...
  public void example2() {
    new JoinExperiment.Builder()
        .lhs(new CompatFactorSpaceSpec("L").addFactors(2, 20), 4)
        .rhs(new CompatFactorSpaceSpec("R").addFactors(2, 20), 4)
        .strength(3)
        .times(2)
