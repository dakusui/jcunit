...
public enum ConstraintSet {
  NONE {
    @Override
    public Optional<NormalizedConstraintFactory> constraintFactories(int offset) {
  ...
  public abstract Optional<NormalizedConstraintFactory> constraintFactories(int offset);
