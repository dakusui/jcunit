...
public class StandarJoinSandbox {
  @Rule
  ...
  private void runJoin(Function<Requirement, Joiner> joinerFactory, int lhsWidth, int rhsWidth) {
    ...
    SchemafulTupleSet rhs = JoinDataSet
        ...
        .project(IntStream.range(0, rhsWidth).mapToObj(factorNameFormatter).collect(toList()));
