...
public abstract class IPOOptimizer {
   ...
   *
   * @param AP$               All pairs covered by choosing the value returned by this method.
   *                          This value is always empty when this method is called.
   * @param currentTestRunSet A TestRunSet object that represents currently added test runs so
   *                          far.
   * @param testRun           A test run that gives the values of the other fields than
   *                          <code>fieldId</code>
   * @param fieldId           An id of field the returned value should be set to.
