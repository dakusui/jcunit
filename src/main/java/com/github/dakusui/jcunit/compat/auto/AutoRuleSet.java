...
public class AutoRuleSet extends RuleSet implements TestRule {
	 ...
	 */
	protected Object outFieldNames() throws LisjCheckedException, CUT {
	 ...
	 * @throws CUT                                                         Operation is cut. Usually not thrown.
	 */
	protected boolean isStored(Object fieldName) throws LisjCheckedException, CUT {
	 ...
	 * @throws LisjCheckedException Failed to get field names.
	 * @throws CUT                  Operation is cut. Usually not thrown.
	 */
	protected Object load(Object fieldName) throws LisjCheckedException, CUT {
		return new Load()
				.bind(this.getTestName(), this.getTargetObject(), fieldName);
	}
	 ...
	 *
	 * @param fieldName Name of the field.
	 * @throws LisjCheckedException Failed to store the value.
	 * @throws CUT                  Operation is cut. Usually not thrown.
	 */
	protected void store(Object fieldName) throws LisjCheckedException, CUT {
