...
public class IPOValuePair {
  ...
  /**
   * Checks if the given object is <code>equals</code> to this object. Note that
   * since the intention of IPO algorithm is to generate all the possible pairs
   * in the test space, the order of A.r and B.s must be ignored. That is if we
