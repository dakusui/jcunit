...
public abstract class SchemafulTupleGeneratorBase implements SchemafulTupleGenerator {
  ...
  final public void init(Object[] params) {
    this.params = params;
    this.cur = 0;
    this.size = initializeSchemafulTuples(params);
  }
  ...
  public abstract Tuple getSchemafulTuple(int testId);
