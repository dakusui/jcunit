...
public class RecordedSchemafulTuplePlayer extends SchemafulTupleGeneratorBase {
  ...
  protected long initializeSchemafulTuples(Object[] params) {
    File baseDir = Utils.baseDirFor(getTargetClass());
    ...
    ConfigUtils.checkEnv(tupleDirs != null,
        "Test hasn't been run with 'JCUnitRecorder' rule yet.");
    ...
    return new ParamType[] {
        new ParamType.NonArrayType() {
          ...
          @Override public String toString() {
            return RecordedSchemafulTuplePlayer.class.getCanonicalName()
                + ".ReplayMode";
          }
