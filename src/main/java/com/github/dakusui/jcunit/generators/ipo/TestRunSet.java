...
public class TestRunSet extends ArrayList<TestRun> {
	 ...
	 * If a value not to be added is given, a <code>RuntimeException</code> will be thrown.
	 * 
	...
	/**
	 * Returns an array of parameter IDs by which you can get call as <code>F</code> in
	 * <code>valueOf(int F, int i)</code>.
	 * 
