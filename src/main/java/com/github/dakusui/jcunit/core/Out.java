...
/**
 * An annotation to tell JCUnit framework that a field is an output and
...
public @interface Out {
	...
	public static interface Verifier {
		 ...
		 * 
		 * @param expected An expected object. Typically stored as local file by JCUnit framework.
		 * @param actual An actual object.
		 * @return true - actual object considered to be verified with expected object / false - otherwise.
		 */
	...
	/**
	 * Returns a Verifier class to be used for verifying loaded object.
	 * This method is only used by 'automated regression framework'.
