...
public class DefaultRuleSetBuilder implements RuleSetBuilder, Context {
	...
	public DefaultRuleSetBuilder() {
		...
		registerPresetForm(new Or() { 
			...
			@Override public Object bind(final Object... params) { 
				// Since bind method destroys params, need to pass a cloned array to the bind
				// calls but the last one.
				return super.bind(new Gt().bind(params.clone()), new Same().bind(params));
			}
			@Override public String name() { return "ge"; }
		});
		...
		registerPresetForm(new Not() { 
			...
			@Override public Object bind(final Object... params) { 
				...
				// being given, we need to pass it packing into an array of java.lang.Object.
				return super.bind(new Gt().bind(params));
			}
			@Override public String name() { return "le"; }
		});
		...
		registerPresetForm(new Not() { 
			...
			@Override public Object bind(final Object... params) { 
				...
				return super.bind(new Or() {
					private static final long serialVersionUID = 1L;
					@Override public Object bind(Object... params_) {
		...
		registerPresetForm(new Not() { 
			...
			@Override public String name() { return "ne"; }
		});
		registerPresetForm(new Not());
		registerPresetForm(new Or());
