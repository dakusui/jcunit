...
/**
 */
public class CompatFrameworkMethodUtils {
    static boolean validateTestPreconditionMethod(Class<?> testClass, FrameworkMethod method, List<String> failures) {
    ...
    static List<FrameworkMethod> getTestPreconditionMethodsFor(Class<?> testClass,
        ...
        for (FrameworkMethod each : ret) {
            CompatFrameworkMethodUtils.validateTestPreconditionMethod(testClass, each, failures);
        }
        return ret;
    }
