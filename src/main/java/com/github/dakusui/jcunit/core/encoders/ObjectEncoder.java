...
public interface ObjectEncoder {
   ...
   * 
   * @param os
   *          An <code>OutputStream</code> to which <code>obj</code> will be
   *          written.
   * @param obj
   *          An object to be written.
   * @throws IOException
   *           Failed to write the object to the output stream.
   */
   ...
   * 
   * @param is
   *          An input stream from which an object will be returned.
   * @return An object read from the input stream.
   * @throws IOException
   *           Failed to load an object from the input stream.
   */
