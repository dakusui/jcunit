...
public abstract class ParamType implements Cloneable {
  ...
  public static final ParamType BooleanArray = new ArrayType(ParamType.Boolean);
  public static final ParamType ByteArray    = new ArrayType(ParamType.Byte);
  public static final ParamType CharArray    = new ArrayType(ParamType.Char);
  public static final ParamType ShortArray   = new ArrayType(ParamType.Short);
  public static final ParamType IntArray     = new ArrayType(ParamType.Int);
  public static final ParamType LongArray    = new ArrayType(ParamType.Long);
  public static final ParamType FloatArray   = new ArrayType(ParamType.Float);
  public static final ParamType DoubleArray  = new ArrayType(ParamType.Double);
  public static final ParamType StringArray  = new ArrayType(ParamType.String);
}
