...
public interface Context extends Cloneable {
   ...
   * @throws SymbolNotFoundException The symbol wasn't bound.
   */
   ...
   * <code>value</code>.
   *
   * @param symbol A symbol to be registered to this context.
   * @param value  A value to be bound.
   ...
   *
   * @param form    A form to be registered.
   * @param aliases Aliases for the form.
   */
