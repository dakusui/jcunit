...
public class Basic {
   ...
   *
   * @param a The first object to be checked.
   * @param b The second object to be checked.
  ...
  public static Object eval(Context context, Object var)
    ...
    if (car instanceof Form) {
      ...
      String msg = String
          .format("car(%s) of var(%s) must be a form or a symbol.", tostr(car),
              tostr(var));
  ...
  public static boolean evalp(Context context, Object predicate)
    ...
    String message = String
        .format("'%s' returned non-boolean value or it is not a predicate",
            predicate);
  ...
  public static abstract class SexpIterator
  ...
  public static class ConsIterator extends SexpIterator {
    ...
    @Override
    public boolean hasNext() {
      return cur < ((Object[]) target).length;
    }
