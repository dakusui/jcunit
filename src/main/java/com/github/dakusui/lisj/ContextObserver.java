...
public interface ContextObserver {
   ...
   * given form begins.
   *
   * @param form   A form which is being evaluated.
   * @param params Parameters given to the form.
   */
   ...
   *
   * @param form A form which is being evaluated.
   * @param ret  A form result returned by the evaluation process.
   */
   ...
   * @param form  A form which is being evaluated.
   * @param index An index of parameter object.
   * @param e     A <code>cut</code> object which cut the evaluation process.
   */
   ...
   *
   * @param form A form which is being evaluated.
   * @param cur  A parameter of <code>form</code> which is being processed.
   * @param ret  A form result returned by the evaluation process.
   */
   ...
   *
   * @param symbol A symbol which is evaluated.
