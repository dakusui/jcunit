...
public class Lambda extends BaseForm {
  ...
  protected FormResult evaluateLast(Context context,
    ...
    final Symbol[] paramSymbols = Utils.cast(Symbol[].class,
        Utils.checknull(evaluatedParams[0]));
    final Object[] funcBody = ArrayUtils.subarray(evaluatedParams, 1,
    ...
    ret.value(new BaseForm() {
      ...
      protected FormResult evaluateEach(Context context, Object currentParam,
        ...
        ret.value(context.bind(
            (Symbol) paramSymbols[lastResult.nextPosition()], currentParam));
