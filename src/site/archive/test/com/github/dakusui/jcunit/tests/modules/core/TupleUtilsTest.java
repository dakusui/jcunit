...
public class TupleUtilsTest {
  ...
  public void saveAndLoadTest() {
    ...
    Tuple tuple2 = IOUtils.loadTuple(new ByteArrayInputStream(baos.toByteArray()));
  ...
  public void loadBrokenTupleTest() {
    IOUtils.loadTuple(new ByteArrayInputStream(new byte[]{}));
  }
  ...
  public void loadInvalieTupleTest() {
    ...
    IOUtils.loadTuple(new ByteArrayInputStream(baos.toByteArray()));
  }
